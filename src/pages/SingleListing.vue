        ...
        <div class="relative flex justify-between w-full">
            ...
            <div>
                ...
                <div role="menubar" class="
                    ...
                    border-red-400
                ">
                    <router-link :to="{ name: 'edit', params: { id: listing.id } }" class="flex justify-between items-center p-2 gap-2">
                        <button class="font-medium rounded-md">Edit Listing</button>
                    ...
                    <button v-on:click="deletePost" class="text-red-400 font-medium p-2 rounded-md flex gap-2">Delete Listing
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
