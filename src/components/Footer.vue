    ...
    <footer class="text-gray-600 body-font w-full">
        ...
        <div class="bg-gray-100">
            <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                <p class="text-gray-500 text-sm text-center sm:text-left">© 2023 Leftover —
                    <a href="https://github.com/cindywongdev" rel="noopener noreferrer" class="text-gray-600 ml-1"
                        target="_blank">@cindywongdev</a>
                </p>
